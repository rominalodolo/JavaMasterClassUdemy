...
public class Main {
    public static void main(String[] args) {
        ...
        displayHighScorePosition("Ane", highScorePosition);

        highScorePosition = calculateHighScorePosition(900);
        displayHighScorePosition("Amy", highScorePosition);
...
//         alternative way to do the conditional with less return statements
        int position =4;
